    ...
    <div class="container-fluid p-0">
      ...
      <div class="card">
        <form @submit.prevent="handleSubmit">
          <div class="card-header"><h5 class="card-title mb-0">{{ isEditMode ? 'Edit' : 'Add' }} Receipt</h5></div>
          <div class="card-body">
            <div class="row">
              <div class="col-md-6"><FormSelect name="project_id" label="Project" v-model="formBody.project_id" :items="projects" /></div>
              <div class="col-md-6"><FormSelect name="invoice_id" label="Invoice" v-model="formBody.invoice_id" :items="invoices" :disabled="isEditMode"/></div>
              ...
              <div class="col-md-6"><FormInput name="original_amount" label="Original Amount (PKR)" v-model="formBody.original_amount" type="number" /></div>
            </div>
          </div>
