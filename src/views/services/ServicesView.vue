...
const handleDelete = async () => {
  try {
    await api.delete(`api/services/${selectedService.value!.id}`)
    reload()
  } catch {}
  modalDelete!.hide()
}
  ...
  <main class="content">
    <div class="container-fluid p-0">
      ...
      <div class="mb-3 text-end">
        <RouterLink to="/services/create" class="btn btn-success">Add new</RouterLink>
      </div>
      <div class="card">
        <div class="card-body">
          <AppDataTable
          ...
          >
            <template #cell-actions="{ row }">
              <RouterLink :to="`/services/${row.id}/edit`" class="btn btn-info btn-sm me-2"
                >Edit</RouterLink
              >
